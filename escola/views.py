...
class ListaMatriculaCurso(generics.ListAPIView):
    def get_queryset(self):
        queryset = Matricula.objects.filter(curso_id=self.kwargs['pk']) # dicionário self.kwargs. Basicamente, esse dicionário salva todas as informações que nos são passadas na URL.
        return queryset
